...
export function LoginView({ isDesktop }: LoginProps) {
  const { method, setMethod, isLoading, setIsLoading } = useLogin();
      ...
      >
        ...
        >
          ...
          >
            ...
            {method === "sign-in" && (
              <SignInForm setMethod={setMethod} setIsLoading={setIsLoading} />
            )}
            {method === "sign-up" && (
              <SignUpForm setMethod={setMethod} setIsLoading={setIsLoading} />
            )}
