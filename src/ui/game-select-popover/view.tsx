  ...
  return (
    <section>
      <Popover>
        ...
        <PopoverContent className="bg-gradient-to-tr from-zinc-950 via-zinc-950 to-zinc-900 border-transparent shadow-md mt-4 text-zinc-50 p-4 flex justify-center">
