  ...
  return (
    ...
    >
                ...
                <Image
                  ...
                  src={
                    games.find(
                      (game) =>
                        game.slug ===
                        Object.values(posts.posts[currentIndex].categories)[0]
                          .slug
                    )?.icon_url ?? ""
                  }
                />
                {Object.values(posts.posts[currentIndex].categories)[0].name}
              </span>
              <h2
                className={`${
      ...
      <Link
        ...
        href={`noticias/${
          Object.values(posts.posts[currentIndex].categories)[0].slug
        }/${posts.posts[currentIndex].slug}`}
      />
